...
VALUES (1, '-Users-me-v8-project', '-Users-me-v8-project');
...
INSERT INTO sessions (
  ...
  1, 'shared-session', 1, 'Migrate legacy session uniqueness', 2,
  '2024-01-04T00:00:00Z', '2024-01-04T00:00:05Z', 'main',
  '/Users/me/v8-project', 1, '{"Bash":1}', 9, '/src/shared-session.jsonl'
);
...
VALUES
  (
    ...
    'v8-msg-1',
    '[{"type":"tool_use","id":"v8-tu1","name":"Bash","input":{"command":"echo v8"}},{"type":"text","text":"Running v8 command."}]',
    '/Users/me/v8-project',
    'main'
  ),
  (
    ...
    'v8-msg-2',
    '[{"type":"tool_result","tool_use_id":"v8-tu1","content":"v8 ok"}]',
    '/Users/me/v8-project',
    'main'
  );
