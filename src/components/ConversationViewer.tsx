  ...
  return (
    <>
      {content.map((block, i) => {
        ...
        switch (block.type) {
          case "text":
            return <TextContent key={i} text={(block as TextBlock).text} />;
          case "tool_use":
            return <ToolUseContent key={i} block={block as ToolUseBlock} />;
          case "tool_result":
            return (
              <ToolResultContent key={i} block={block as ToolResultBlock} />
            );
          default:
            return null;
        }
