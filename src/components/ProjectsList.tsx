	...
	return (
		<SearchInput
			...
			renderItem={(project) => (
				...
				>
					<span className="text-zinc-200 text-sm truncate">{project.displayName}</span>
					<span className="text-zinc-500 text-xs shrink-0">{project.sessionCount} sessions</span>
				</a>
			)}
		/>
	)
